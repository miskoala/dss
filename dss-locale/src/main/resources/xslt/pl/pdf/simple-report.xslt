		...
		<fo:root>
			...
			<fo:bookmark-tree>
				<fo:bookmark>
					...
					<fo:bookmark-title>Polityka weryfikacji</fo:bookmark-title>
				</fo:bookmark>
				...
				<fo:bookmark>
					...
					<fo:bookmark-title>Informacje o dokumencie</fo:bookmark-title>
				</fo:bookmark>
			</fo:bookmark-tree>
			...
			<fo:table-body>
				...
				<fo:table-row>
					...
					<fo:table-cell>
						...
						<fo:block>
							<xsl:attribute name="padding-bottom">3px</xsl:attribute>
							[do tłumaczenia] The validation of the signature, of its supporting certificates and of the related certification path has been performed from this reference time.
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
		...
		<fo:table-row>
			<fo:table-cell>
				<fo:block>
					<xsl:attribute name="padding-bottom">3px</xsl:attribute>
					<xsl:attribute name="font-weight">bold</xsl:attribute>
					[do tłumaczenia]Signature filename : 
				</fo:block>
			</fo:table-cell>
			<fo:table-cell>
				<fo:block>
