...
<!-- 			</fo:bookmark-tree> -->
	...
	<xsl:template match="dss:BasicBuildingBlocks">
		<fo:block>
    		...
    		[do tłumaczenia]Basic Building Blocks
    		<fo:block>
	...
	<xsl:template match="dss:ValidationProcessBasicSignatures">
		<fo:block>
			...
			<xsl:attribute name="font-weight">bold</xsl:attribute>
       		...
       		<xsl:attribute name="margin-bottom">5px</xsl:attribute>
    		[do tłumaczenia]Validation Process for Basic Signatures
    	</fo:block>
       	<xsl:apply-templates/>
       	<fo:block>
	...
	<xsl:template match="dss:ValidationProcessTimestamps">
		<fo:block>
			...
			<xsl:attribute name="font-weight">bold</xsl:attribute>
       		...
       		<xsl:attribute name="margin-top">15px</xsl:attribute>
       		<xsl:attribute name="margin-bottom">5px</xsl:attribute>
    		[do tłumaczenia]Validation Process for Timestamps 
    		<fo:block>
	    		<xsl:attribute name="font-size">7pt</xsl:attribute>
	...
	<xsl:template match="dss:ValidationProcessArchivalData">
		<fo:block>
			...
			<xsl:attribute name="font-weight">bold</xsl:attribute>
       		...
       		<xsl:attribute name="margin-top">15px</xsl:attribute>
       		<xsl:attribute name="margin-bottom">5px</xsl:attribute>
    		[do tłumaczenia]Validation Process for Signatures with Archival Data
    	</fo:block>
    	<xsl:if test="count(child::*[name(.)!='Conclusion']) &gt; 0">
        	<xsl:apply-templates/>
        	<fo:block>
	...
	<xsl:template match="dss:ValidationProcessLongTermData">
		<fo:block>
			...
			<xsl:attribute name="font-weight">bold</xsl:attribute>
       		...
       		<xsl:attribute name="margin-top">15px</xsl:attribute>
       		<xsl:attribute name="margin-bottom">5px</xsl:attribute>
    		[do tłumaczenia]Validation Process for Signatures with Time and Signatures with Long-Term Validation Data
    	</fo:block>
    	<xsl:if test="count(child::*[name(.)!='Conclusion']) &gt; 0">
        	<xsl:apply-templates/>
        	<fo:block>
    ...
    <xsl:template match="dss:TLAnalysis">
		<fo:block>
			...
			<xsl:attribute name="font-weight">bold</xsl:attribute>
       		...
       		<xsl:attribute name="margin-top">15px</xsl:attribute>
       		<xsl:attribute name="margin-bottom">5px</xsl:attribute>
    		[do tłumaczenia]TL analysis  <xsl:value-of select="@CountryCode"/>
    	</fo:block>
    	<xsl:if test="count(child::*[name(.)!='Conclusion']) &gt; 0">
        	<xsl:apply-templates/>
        	<fo:block>
    ...
    <xsl:template match="dss:SignatureAnalysis">
		<fo:block>
			...
			<xsl:attribute name="font-weight">bold</xsl:attribute>
       		...
       		<xsl:attribute name="margin-top">15px</xsl:attribute>
       		<xsl:attribute name="margin-bottom">5px</xsl:attribute>
    		[do tłumaczenia]Qualification Signature <xsl:value-of select="@Id"/>
    	</fo:block>
    	<xsl:if test="count(child::*[name(.)!='Conclusion']) &gt; 0">
        	<xsl:apply-templates/>
        	<fo:block>
		    				...
		    				<xsl:choose>
								...
								<xsl:when test="name(.) = 'SubXCV'">
									<xsl:choose>
										...
										<xsl:otherwise>[do tłumaczenia]Certificate : </xsl:otherwise>
									</xsl:choose>
								</xsl:when>
