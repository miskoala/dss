		...
		<fo:root>
			...
			<fo:bookmark-tree>
				<fo:bookmark>
					...
					<fo:bookmark-title>${text.validation.policy}</fo:bookmark-title>
				</fo:bookmark>
				...
				<fo:bookmark>
					...
					<fo:bookmark-title>${text.document.informations}</fo:bookmark-title>
				</fo:bookmark>
			</fo:bookmark-tree>
